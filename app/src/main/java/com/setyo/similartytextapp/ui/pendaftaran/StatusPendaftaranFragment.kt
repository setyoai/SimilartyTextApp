...
import com.setyo.similartytextapp.databinding.FragmentStatusPendaftaranBinding
import com.setyo.similartytextapp.ui.ViewModelFactory

class StatusPendaftaranFragment : Fragment() {

    private var _binding: FragmentStatusPendaftaranBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentStatusPendaftaranBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolbarStatusPendaftaran.imageViewBack.setOnClickListener {
            view.findNavController().navigate(R.id.action_statusPendaftaranFragment_to_homeFragment)
        }
    }
