package com.setyo.similartytextapp.helper
...
//fun uriToFile(selectedPdf: Uri, context: Context): File {
//    val contentResolver: ContentResolver = context.contentResolver
//    val localFile = createTempFile(context)
//    val inputStream = contentResolver.openInputStream(selectedPdf) as InputStream
//    val outputStream: OutputStream = FileOutputStream(localFile)
//    val buf = ByteArray(1024)
//    var len: Int
//
